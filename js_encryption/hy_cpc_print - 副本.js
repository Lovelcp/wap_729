(function(){
	...
	if(/android/i.test(navigator.userAgent) || /ipad|iphone|mac|ios/i.test(navigator.userAgent))
	{
		...
		var toplink='<a href="http://d.haoghost.com/'+pname+'" id="hy_'+num1+'" style="display:block;margin:0 auto;"><img id="hy_cpc_imgt" src="http://m.haoghost.com/images/wb_t.gif" width=100%/></a>';
